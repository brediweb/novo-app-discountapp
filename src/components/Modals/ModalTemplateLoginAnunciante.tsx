...
const ModalTemplateLoginAnunciante: React.FC<ModalProps> = ({ visible, onClose, width, padding, maxWidth, backgroundColor, closeSecondary, backgroundColorSecondary }) => {
...
export default ModalTemplateLoginAnunciante
