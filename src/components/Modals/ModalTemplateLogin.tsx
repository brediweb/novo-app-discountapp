...
const ModalTemplateLogin: React.FC<ModalProps> = ({ visible, onClose, width, padding, maxWidth, backgroundColor, closeSecondary, backgroundColorSecondary }) => {
...
export default ModalTemplateLogin
